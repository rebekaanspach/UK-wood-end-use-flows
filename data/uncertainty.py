...
conversion_factor_distributions_1 = {
    ...
    (QUANTITYKIND.GreenMass, SYS.SoftwoodRoundwood): make_uniform_distribution((1 / 1.018), (1 / 1.018)),
    (QUANTITYKIND.GreenMass, SYS.HardwoodRoundwood): make_uniform_distribution((1 / 1.143), (1 / 1.143)),
    (QUANTITYKIND.Mass, SYS.SoftwoodRoundwood): make_uniform_distribution((1 / 1.018), (1 / 1.018)),
    (QUANTITYKIND.Mass, SYS.RoundwoodToFencingAndOutdoor): make_uniform_distribution((1 / 1.018), (1 / 1.018)), # Fencing
    ...
    (QUANTITYKIND.Mass, SYS.OtherEngineeredWoodProducts): make_uniform_distribution(1 / 0.595, 1 / 0.464),
    (QUANTITYKIND.Mass, SYS.WBPFibres): no_distribution,


    # By-products, fibres for recycling and industrial residues
    (QUANTITYKIND.GreenMass, SYS.ByProducts): make_uniform_distribution((1 / 1.043), (1 / 1.018)),
    (QUANTITYKIND.Mass, SYS.ByProducts): make_uniform_distribution(0.87, 0.98),
    (QUANTITYKIND.GreenMass, SYS.RecycledWoodFibre): make_uniform_distribution((1 / 1.043), (1 / 1.018)), #Fibres for recycling 
    (QUANTITYKIND.Mass, SYS.RecycledWoodFibre): make_uniform_distribution((1 / 0.595), (1 / 0.467)), #Fibres for recycling 
    (QUANTITYKIND.Mass, SYS.PreConsumerWasteProducts): no_distribution,  #Industrial residues 
    (QUANTITYKIND.Mass, SYS.PreConsumerWasteConstruction): no_distribution, #Industrial residues 
    (QUANTITYKIND.Mass, SYS.RecycledWoodFibreToPallets): no_distribution, #Fibres for recycling
    (QUANTITYKIND.Mass, SYS.PostConsumerWood): make_uniform_distribution((1 / 0.595), (1 / 0.467)), #Fibres for recycling
    (QUANTITYKIND.Volume, SYS.PostConsumerWood): no_distribution,


    # Pulp and paper
    (QUANTITYKIND.Mass, SYS.GraphicPapers): make_uniform_distribution(((1 - 0.30) / (0.467 * (1 + 0.06))), ((1 - 0.10) / (0.467 * (1 + 0.04)))),
    (QUANTITYKIND.Mass, SYS.SanitaryPapers): make_uniform_distribution((1 / (0.467 * (1 + 0.06))), (1 / (0.467 * (1 + 0.04)))),
    (QUANTITYKIND.Mass, SYS.Packaging): make_uniform_distribution(((1 - 0.10) / (0.467 * (1 + 0.06))), ((1 - 0.10) / (0.467 * (1 + 0.04)))),
    (QUANTITYKIND.Mass, SYS.OtherPaperProducts): make_uniform_distribution(((1 - 0.23) / (0.467 * (1 + 0.06))), ((1 - 0.23) / (0.467 * (1 + 0.04)))),
    ...
    (QUANTITYKIND.Mass, SYS.RecycledPaper): make_uniform_distribution(1 / 0.628, 1 / 0.628), #paper for recycling
    ...
    # Fencing
    (QUANTITYKIND.Mass, SYS.FencingPosts): make_uniform_distribution((1 / 1.043), (1 / 1.018)),
    (QUANTITYKIND.Mass, SYS.FencingRailsAndBoards): no_distribution,


    #Construction
    (QUANTITYKIND.Dimensionless, SYS.WoodenOutbuildings): make_uniform_distribution((1 / (6 * 0.595)), (1 / (2 * 0.467))),
    (QUANTITYKIND.Mass, SYS.RailwaySleepers): make_uniform_distribution((1 / (1 + 0.08)), (1 / (1 + 0.06))),
    ...
    (QUANTITYKIND.Mass, SYS.OtherEnergyFeedstocks): make_uniform_distribution(
        ((41868) / (0.595 * (1 + 0.20) * 20.3)),
        ((41868 * 0.0036) / (0.595 * (1 + 0.1) * 16.3)),),
